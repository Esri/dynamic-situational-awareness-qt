 ...
 * `git clone --branch 100.15.0.final https://github.com/Esri/arcgis-runtime-toolkit-qt.git`
...
git clone --branch 100.15.0.final https://github.com/Esri/arcgis-runtime-toolkit-qt
```
