...
/*!
  \class Esri::ArcGISRuntime::CoordinateConversionResults
  ...
  \table
    ...
    \row
        ...
        \li \l {Esri::ArcGISRuntime::CoordinateConversionResults::CoordinateConversionResultsNameRole}{CoordinateConversionResultsNameRole}
    \row
        \li notation
        \li QString
        \li The resulting notation from any conversion operations.
        \li \l {Esri::ArcGISRuntime::CoordinateConversionResults::CoordinateConversionResultsNotationRole}{CoordinateConversionResultsNotationRole}
    \row
        \li type
        \li int (as CoordinateConversionOptions::CoordinateType)
        \li The format used for the conversion.
        \li \l {Esri::ArcGISRuntime::CoordinateConversionResults::CoordinateConversionResultsCoordinateTypeRole}{CoordinateConversionResultsCoordinateTypeRole}
  \endtable
