...
void DsaController::writeDefaultMessageFeeds()
{
  ...
  QJsonObject cotRenderJson;
  cotRenderJson.insert(MessageFeedConstants::MESSAGE_FEEDS_RENDERER_STYLE, QStringLiteral("mil2525c"));
  cotRenderJson.insert(MessageFeedConstants::MESSAGE_FEEDS_RENDERER_ICON, QStringLiteral("saevents.png"));
  cotMessageFeedJson.insert(MessageFeedConstants::MESSAGE_FEEDS_RENDERER, cotRenderJson);
  ...
  QJsonObject friendlyTracksRenderJson;
  friendlyTracksRenderJson.insert(MessageFeedConstants::MESSAGE_FEEDS_RENDERER_STYLE, QStringLiteral("mil2525c"));
  friendlyTracksRenderJson.insert(MessageFeedConstants::MESSAGE_FEEDS_RENDERER_ICON, QStringLiteral("friendlytracks.png"));
  friendlyTracksLandJson.insert(MessageFeedConstants::MESSAGE_FEEDS_RENDERER, friendlyTracksRenderJson);
  ...
  friendlyTracksAirRenderJson.insert(MessageFeedConstants::MESSAGE_FEEDS_RENDERER_ICON, QStringLiteral("friendlytracks2.png"));
  ...
  QJsonObject spotRepRenderJson;
  spotRepRenderJson.insert(MessageFeedConstants::MESSAGE_FEEDS_RENDERER_ICON, QStringLiteral("enemycontact1600.png"));
  spotRepJson.insert(MessageFeedConstants::MESSAGE_FEEDS_RENDERER, spotRepRenderJson);
  ...
  QJsonObject sitRepRenderJson;
  sitRepRenderJson.insert(MessageFeedConstants::MESSAGE_FEEDS_RENDERER_ICON, QStringLiteral("sitrep1600.png"));
  sitRepJson.insert(MessageFeedConstants::MESSAGE_FEEDS_RENDERER, sitRepRenderJson);
  ...
  QJsonObject eodRenderJson;
  eodRenderJson.insert(MessageFeedConstants::MESSAGE_FEEDS_RENDERER_ICON, QStringLiteral("eod1600.png"));
  eodReportsJson.insert(MessageFeedConstants::MESSAGE_FEEDS_RENDERER, eodRenderJson);
  ...
  QJsonObject senserObsRenderJson;
  senserObsRenderJson.insert(MessageFeedConstants::MESSAGE_FEEDS_RENDERER_ICON, QStringLiteral("sensorobs1600.png"));
  sensorObsJson.insert(MessageFeedConstants::MESSAGE_FEEDS_RENDERER, senserObsRenderJson);
